...
describe("Distributor", () => {
    ...
    describe("constructor", () => {
        ...
        it("does not accept 0x0 as PLUS address", async () => {
            await expect(
                new Distributor__factory(owner).deploy(
                    treasuryFake.address,
                    ZERO_ADDRESS,
    ...
    describe("post-construction", () => {
        ...
        describe("distribute", () => {
            ...
            it("mint from treasury and distribute to recipients", async () => {
                ...
                plusFake.totalSupply.returns(10000000);
                await distributor.connect(staking).distribute();
        ...
        describe("nextRewardAt", () => {
            it("returns the number of PLUS to be distributed in the next epoch", async () => {
                plusFake.totalSupply.returns(3899568500546135);
        ...
        describe("nextRewardFor", () => {
            it("returns the number of PLUS to be distributed to the given address in the next epoch", async () => {
                const rate = 2975;

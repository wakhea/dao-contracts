...
import "./interfaces/IPlutusAuthority.sol";

import "./types/PlutusAccessControlled.sol";

contract PlutusAuthority is IPlutusAuthority, PlutusAccessControlled {
    ...
    constructor(
        ...
        address _policy,
        address _vault
    ) PlutusAccessControlled( IPlutusAuthority(address(this)) ) {
        governor = _governor;

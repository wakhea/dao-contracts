...
contract BondTeller is ITeller, PlutusAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    struct Bond {
        ...
        uint256 payout; // sPLUS remaining to be paid. agnostic balance
    ...
    IERC20 internal immutable PLUS;
    IsPLUS internal immutable sPLUS; // payment token
    ...
    function newBond(
        ...
        PLUS.approve(address(staking), _payout);
    ...
    function getReward() external override {
        ...
        FERs[msg.sender] = 0;
        PLUS.safeTransfer(msg.sender, reward);
    }
    ...
    function pay(address _bonder, uint256 _amount) internal {
        sPLUS.safeTransfer(_bonder, _amount);
    }
    ...
    /**
     * @notice calculate amount of PLUS available for claim for single bond
     * @param _bonder address
    ...
    /**
     * @notice calculate amount of PLUS available for claim for array of bonds
     * @param _bonder address
